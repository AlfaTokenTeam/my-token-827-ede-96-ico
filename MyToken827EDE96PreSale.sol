...
import "./MyToken827EDE96.sol";

contract MyToken827EDE96PreSale {
    MyToken827EDE96 public token;
    ...
    function MyToken827EDE96PreSale(
        MyToken827EDE96 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken827EDE96(_token);
